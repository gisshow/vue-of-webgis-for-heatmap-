        ...
        return t.prototype = {
            update: function (e, t, n, a, o, s) {
                var l = this._getBrush(), c = this._getGradient(e, o, "inRange"),
                    u = this._getGradient(e, o, "outOfRange"), h = this.pointSize + this.blurSize, d = this.canvas,
                ...
                var e = this._brushCanvas || (this._brushCanvas = n.createCanvas()), t = this.pointSize + this.blurSize,
                    r = 2 * t;
